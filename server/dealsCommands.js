...
const dropTableDeals = () => {
  return `DROP TABLE tbl_deals CASCADE;`;
}

const insertIntoDeals = () => {
  return `INSERT INTO tbl_deals (company_name, date, amount_invested, valuation)
